...
@section('content')
    ...
    <div class="aboutus">
        ...
        <div class="aboutus-right">
            <h5>Tentang Kami</h5>
            <h6>Baitul Quran <span>Al Jahra</span></h6>
            <p>
    ...
    <div class="lembaga">
        <div class="lembaga-title">
            <h6>Lembaga</h6>
            <h1>Lembaga <span>Sekolah</span></h1>
            <p>Beberapa Lembaga yang ada di Pesantren Baitul Quran Al Jahra</p>
        </div>
        <div class="lembaga-group">
            <div class="lembaga-card">
                <img src="{{ asset('frontend/assets/image/dumy_windows.png') }}" />
                <img src="{{ asset('frontend/assets/image/dumy_windows.png') }}" />
                <img src="{{ asset('frontend/assets/image/dumy_windows.png') }}" />
                <img src="{{ asset('frontend/assets/image/dumy_windows.png') }}" />
                <img src="{{ asset('frontend/assets/image/dumy_windows.png') }}" />
